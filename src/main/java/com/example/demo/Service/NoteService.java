...
public class NoteService {
    ...
    private final NoteRepository noteepository;

    @Autowired
    public NoteService(NoteRepository noteepository) {
        this.noteepository = noteepository;
    }
...
///////////////////////////////////////
    ...
    /*public void authentifier(User user) {
        Optional<User> userbyEmail = noteepository.findUserByEmailUser(user.getEmailUser());
